...
from PyQt6.QtWidgets import (
    ...
    QLabel, QPushButton, QListWidget, QTextEdit, QLineEdit, QMessageBox
)
...
class TokenCallbackHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if "/callback" in self.path:
            ...
            self.end_headers()
            self.wfile.write(b"<h1>Authentication Successful!</h1><p>You may close this tab and return to the application.</p>")
    ...
    def run(self):
        ...
        while self.running:
            ...
            try:
                ...
                if current_clip and isinstance(current_clip, str) and current_clip != self.last_clip:
...
class MainWindow(QMainWindow):
    ...
    def paste_from_clipboard(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Clipboard Error", f"Failed to read clipboard: {e}")
